...
public class poran {
    poran() throws IOException{
        
        JFrame f=new JFrame("MINIBUSTAR Poran");   
        f.setContentPane(new JLabel(new ImageIcon(ImageIO.read(new File("D:\\poran.jpg")))));
    final JLabel text = new JLabel("Timings for Poran:");
...
if(a==JOptionPane.YES_OPTION){  
     try {  
         ...
         Logger.getLogger(poran.class.getName()).log(Level.SEVERE, null, ex);
     }
}         
        }
}); 
