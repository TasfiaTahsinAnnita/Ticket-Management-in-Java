...
public class hawa {
    hawa() throws IOException{
    JFrame f=new JFrame("MINIBUSTAR Hawa"); 
     f.setContentPane(new JLabel(new ImageIcon(ImageIO.read(new File("D:\\hawa.jpg")))));
    final JLabel text = new JLabel("Timings for Hawa:");
...
if(a==JOptionPane.YES_OPTION){  
     try {  
         ...
         Logger.getLogger(hawa.class.getName()).log(Level.SEVERE, null, ex);
     }
}         
